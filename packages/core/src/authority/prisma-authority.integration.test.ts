...
async function createSchema(client: PrismaClient): Promise<void> {
  ...
  for (const statement of [
    ...
    `CREATE TABLE "Authority" ("id" TEXT NOT NULL PRIMARY KEY, "installationKey" TEXT NOT NULL DEFAULT 'PRIMARY' CHECK ("installationKey" = 'PRIMARY') UNIQUE, "issuerId" TEXT NOT NULL UNIQUE, "auditSequence" INTEGER NOT NULL DEFAULT 0, "createdAt" DATETIME NOT NULL, "updatedAt" DATETIME NOT NULL, UNIQUE("id", "issuerId"))`,
