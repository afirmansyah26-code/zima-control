  ...
  "targets": [
    {
      ...
      "cflags": ["-std=c17", "-O2", "-pthread", "-fPIC", "-fvisibility=hidden", "-fstack-protector-strong", "-D_FORTIFY_SOURCE=3", "-Wall", "-Wextra", "-Wpedantic", "-Werror", "-Wconversion", "-Wsign-conversion", "-Wformat=2", "-Wshadow", "-Wstrict-prototypes", "-Wmissing-prototypes"],
